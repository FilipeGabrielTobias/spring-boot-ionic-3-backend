...
CREATE TABLE `cidade` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKhqumryw75m7cj2i1jcun0mlsj` (`fk_estado`)
...
INSERT INTO `cliente` VALUES (1,'031.495.752-90','tobias.filipe@gmail.com','Maria','$2a$10$S3GzcBYBmrHrUZUE.I31W.aQ78n2D6X5KAueO/l9gKyCJjB/6dl3u',1),(2,'628.426.582-48','filipe_fgt@hotmail.com','José','$2a$10$ABOik4QVuk.Y80K4Qt927.KktFVemAOU7NdtLlnVMQF7KFV4pDouO',1);
...
CREATE TABLE `endereco` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK1psl3e0icdouluru254nb0r3s` (`fk_cidade`),
...
CREATE TABLE `item_pedido` (
  ...
  KEY `FKr8w088c0q0jwjecm58pdtkswp` (`fk_produto`)
...
CREATE TABLE `pedido` (
  ...
  `fk_cliente` int(11) DEFAULT NULL,
  `fk_endereco_entrega` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKg3dm7v4kilvvujf01n8ikqeaq` (`fk_cliente`),
  KEY `FKhrg4g061hwt1fjecgr0v1l5cn` (`fk_endereco_entrega`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `telefone` VALUES (1,'27363323'),(1,'93838393'),(1,'33334444'),(1,'88887777');
...
-- Dump completed on 2018-08-08 11:36:52
